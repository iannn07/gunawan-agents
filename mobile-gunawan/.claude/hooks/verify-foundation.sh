...
#   }
#
# Note: In the ai-software-factory repo, foundation/ lives at the project root
# (not inside .gunawan/) — this repo IS the Gunawan template source.
...
if [ ${#MISSING[@]} -gt 0 ]; then
  ...
  echo ""
  echo "Action required: ensure foundation/ is present and non-empty."
